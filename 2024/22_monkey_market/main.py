...
def main():
    test1 = "test_input.txt", 37327623 
    test2 = "test_input_2.txt", 23
    real = "input.txt"

    # For days where the input is a list of inputs treated separately
    unit_tests(test1[0], (8685429, 4700978, 15273692, 8667524), part2=False)
